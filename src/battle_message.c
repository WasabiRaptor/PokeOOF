...
const u8 gText_PlayerWhiteout[] = _("{B_PLAYER_NAME}’s Pokemon \nare all fucking dead!\p");
const u8 gText_PlayerWhiteout2[] = _("{B_PLAYER_NAME} got fucking mugged!{PAUSE_UNTIL_PRESS}");
