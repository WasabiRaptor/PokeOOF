...
static const u8 sUnknown_085A1E3C[][3] = {
    ...
    {MAP_GROUP(HUHFORD_TOWN), MAP_NUM(HUHFORD_TOWN), 15},
...
static u8 get_flagnr_blue_points(u16 mapSecId)
{
    switch (mapSecId)
    {
        ...
        case MAPSEC_HUHFORD_TOWN:
            return FlagGet(FLAG_VISITED_HUHFORD_TOWN) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
